<?php 
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'http://ec2-54-81-75-101.compute-1.amazonaws.com/TipoProducto/'.$_POST['tipr_id'],
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'http://ec2-54-81-75-101.compute-1.amazonaws.com/TipoProducto/'.$_GET['tipr_id'],
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => '',
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 0,
