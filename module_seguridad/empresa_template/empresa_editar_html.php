<?php 
	if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        CURLOPT_URL => 'http://ec2-54-81-75-101.compute-1.amazonaws.com/empresa/'.$_POST['empr_id'],
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://ec2-54-81-75-101.compute-1.amazonaws.com/empresa/'.$_GET['empr_id'],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
